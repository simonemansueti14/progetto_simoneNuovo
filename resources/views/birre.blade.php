...
@section('content')
    <h2 class="section-title-bottiglie">Le nostre birre</h2>
    <p class="birra-subtitle">Produciamo birre artigianali con passione e ingredienti locali.</p>

    <div class="beer-carousel-wrapper">
        <!-- Bottone sinistra -->
        <button class="carousel-btn left" onclick="scrollBeers(-1)">&#10094;</button>

        <!-- Carosello con scrollbar -->
